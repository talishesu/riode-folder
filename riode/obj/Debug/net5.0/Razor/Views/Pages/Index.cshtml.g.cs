#pragma checksum "C:\Users\quliy\source\repos\riode-folder\riode\Views\Pages\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "c20d4fa5b1ccd5f854703baed5628f108398c17f"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"c20d4fa5b1ccd5f854703baed5628f108398c17f", @"/Views/Pages/Index.cshtml")]
...
<main class=""main"">
  ...
  ");
        ...
        <section class=""customer-section pb-10 appear-animate"">
          ...
          ");
            WriteLiteral(@"              <a href=""#"" class=""btn btn-dark btn-link btn-underline ls-m"">
                ...
                <div class=""row align-items-center"">
                    <div class=""col-md-6 order-md-first mb-4"">
                        ...
                        <p class=""section-desc text-grey"">
                            ...
                            s page builder and the number is growing more and more. Technolog<br>
                     ");
            WriteLiteral(@"       developing, requirements are increasing. Riode has brought.
                        </p>
        ...
        <section class=""brand-section grey-section pt-10 pb-10 appear-animate"">
            ...
            ");
            WriteLiteral(@"    <h3 class=""section-title lh-1 font-weight-bold text-center mb-5"">Popular Brands</h3>
            ...
            WriteLiteral(@"               'items': 6
                    ...
                    <figure class=""brand-wrap bg-white banner-radius"">
                        <img src=""");
            WriteLiteral(@"images/brands/5.png"" alt=""Brand"" width=""180"" height=""100"" />
                    </figure>
                    <figure class=""brand-wrap bg-white banner-radius"">
                    ...
                    <div class=""member appear-animate""
                        ...
                        <figure class=""banner-radius"">
                            <img src=""images/subpages/team2.jpg"" alt=""team member"" width=""280"" height=""280""
                                ");
            WriteLiteral(@" style=""background-color: #121A1F;"">
                            <div class=""overlay social-links"">
                                <a href=""#"" class=""social-link social-facebook fab fa-facebook-f""></a>
                                <a href=""#"" class=""social-link social-twitter fab fa-twitter""></a>
                                <a href=""#"" class=""social-link social-linkedin fab fa-linkedin-in""></a>
     ...
     ");
            WriteLiteral(@"                       <div class=""overlay social-links"">
                                <a href=""#"" class=""social-link social-facebook fab fa-facebook-f""></a>
                                <a href=""#"" class=""social-link social-twitter fab fa-twitter""></a>
                                <a href=""#"" class=""social-link social-linkedin fab fa-linkedin-in""></a>
                            </div>
